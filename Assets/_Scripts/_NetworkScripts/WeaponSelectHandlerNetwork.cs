...
public class WeaponSelectHandlerNetwork : NetworkBehaviour
{
    ...
    void Update()
    {
        ...
        if ( GetComponent<PlayerStatHandlerNetwork>().hasArrows == true && holdingBow && Input.GetKeyDown(KeyCode.L))
        {
            shootArrow();
        }

        if ( GetComponent<PlayerStatHandlerNetwork>().hasMagic == true && holdingStaff && Input.GetKeyDown(KeyCode.L))
        {
            castMagic();
        }
